...
| **[Agentic RAG on Kubeflow](https://github.com/kubeflow/docs-agent)** | K8s-native multi-agent RAG design (GSoC 2026 proposal) + upstream PRs | 3-collection Milvus architecture · intent routing · KFP/KServe · 30-case test suite |
